            ...
            <div class="course-curriculum-title clearfix">
              ...
              <div class="float-right">
                <span class="total-lectures">
                  <?php echo $this->crud_model->get_lessons('lesson_count_in_course', $course_details['id'])->num_rows().' '.site_phrase('lessons'); ?>
                </span>
      ...
      <div class="includes">
        ...
        <ul>
          <?php if($course_details['course_type'] == 'general'): ?>
            ...
            <li><i class="far fa-file"></i><?php echo $this->crud_model->get_lessons('lesson_count_in_course', $course_details['id'])->num_rows().' '.site_phrase('lessons'); ?></li>
