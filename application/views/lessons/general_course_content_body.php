<div class="col-lg-9  order-md-1 course_col" id = "video_player_area">
    ...
    <div class="" style="text-align: center;">
        ...
        if($lesson_details['lesson_type'] == 'video' || $lesson_details['lesson_type'] == '' || $lesson_details['lesson_type'] == NULL):
            ...
            <?php if ($lesson_details['lesson_type'] == 'video' && (strtolower($provider) == 'youtube' || strtolower($provider) == 'vimeo')): ?>
                <div class="" style="margin: 20px 0; text-align: left;" id = "lesson-summary">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo get_phrase("content"); ?>:</h5>
        ...
        <?php elseif ($lesson_details['lesson_type'] == 'editable'): ?>
    ...
    <?php if ($lesson_details['lesson_type'] != 'editable' && $lesson_details['lesson_type'] != 'video'): ?>
        <div class="" style="margin: 20px 0;" id = "lesson-summary">
            <div class="card">
                <div class="card-body">
