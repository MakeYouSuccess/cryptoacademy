...
<link href="<?php echo base_url('assets/backend/css/vendor/summernote-audio.css') ?>" rel="stylesheet" type="text/css" />
...
<!-- Ropa-Sans -->
<link rel="stylesheet" id="gsf_google-fonts-css" href="https://fonts.googleapis.com/css?family=Ropa+Sans%3A400%2C400i&amp;subset=latin%2Clatin-ext&amp;ver=5.6.1" type="text/css" media="all">