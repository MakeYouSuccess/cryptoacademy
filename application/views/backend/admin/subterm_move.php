...
?>
<form action="<?php echo site_url('admin/subterms/'.$param2.'/move'.'/'.$param3); ?>" method="post">
    ...
    <div class="form-group">
        ...
        <select class="form-control select2" data-toggle="select2" name="term_id" id="term_id">
            <option value=""><?php echo get_phrase('not_select'); ?></option>
    ...
    <div class="text-center">
        <button class = "btn btn-success" type="submit" name="button"><?php echo get_phrase('move_subterm'); ?></button>
    </div>
</form>
...
function onSectionSelect(sectionId) {
    $.ajax({
        ...
        success: function(response)
        {
            ...
            var newOption = new Option("<?php echo get_phrase('not_select'); ?>", "", false, false);
