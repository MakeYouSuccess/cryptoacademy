        ...
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-3">
                    <?php echo get_phrase('blog_adding_form'); ?>
                </h4>

                <div class="row w-100">
                    <div class="col-xl-12">
                        <form class="required-form" action="<?php echo site_url('admin/blog_action/add'); ?>" method="post">
                            <div id="basicwizard">
                                <div class="row justify-content-center">
                                    <div class="col-xl-8">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-2 col-form-label" for="content"><?php echo get_phrase('content'); ?></label>
                                            <div class="col-md-10">
...
$(document).ready(function () {
    initSummerNoteEx(['#content'], "<?php echo site_url('admin/upload_summernote'); ?>");
});
</script>