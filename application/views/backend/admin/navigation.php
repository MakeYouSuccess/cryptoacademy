...
<div class="left-side-menu left-side-menu-detached">
	...
	<ul class="metismenu side-nav side-nav-light">
		...
		<li class="side-nav-item <?php if ($page_name == 'enrol_history' || $page_name == 'enrol_student' || $page_name == 'enrol_course'): ?> active <?php endif; ?>">
			...
			<ul class="side-nav-second-level" aria-expanded="false">
				...
				<li class = "<?php if($page_name == 'enrol_course') echo 'active'; ?>">
					<a href="<?php echo site_url('admin/enrol_course'); ?>"><?php echo get_phrase('enrol_by_course'); ?></a>
				</li>
		...
		<li class="side-nav-item">
			<a href="https://tbv30mblog.waddiwassi.com/admin" class="side-nav-link">
		...
		<li class="side-nav-item">
			<a href="javascript: void(0);" class="side-nav-link <?php if ($page_name == 'migration_evol' || $page_name == 'migration_woo'): ?> active <?php endif; ?>">
				<i class="dripicons-blog"></i>
				<span> <?php echo get_phrase('migration'); ?></span>
				<span class="menu-arrow"></span>
			</a>
			<ul class="side-nav-second-level" aria-expanded="false">
				<li class = "<?php if($page_name == 'migration_evol') echo 'active'; ?>" >
					<a href="<?php echo site_url('admin/migration/evol'); ?>">
						<?php echo get_phrase('evolcampus'); ?>
					</a>
				</li>
				<li class = "<?php if($page_name == 'migration_woo') echo 'active'; ?>" >
					<a href="<?php echo site_url('admin/migration/woo'); ?>"><?php echo get_phrase('woo'); ?></a>
				</li>
			</ul>
		</li>

		<li class="side-nav-item" style="display: none;">
			<a href="javascript: void(0);" class="side-nav-link <?php if ($page_name == 'blog_add' || $page_name == 'blog_manage' || $page_name == 'blog_category_manage'): ?> active <?php endif; ?>">
				<i class="dripicons-blog"></i>
			...
			<ul class="side-nav-second-level" aria-expanded="false">
				<li class = "<?php if($page_name == 'blog_add') echo 'active'; ?>" >
					<a href="<?php echo site_url('admin/blog/add'); ?>">
						<?php echo get_phrase('add_blog'); ?>
					</a>
				</li>
				<li class = "<?php if($page_name == 'blog_manage') echo 'active'; ?>" >
					<a href="<?php echo site_url('admin/blog/manage'); ?>"><?php echo get_phrase('manage_blog'); ?></a>
				</li>
				<li class = "<?php if($page_name == 'blog_category_manage') echo 'active'; ?>" >
					<a href="<?php echo site_url('admin/blog/category'); ?>"><?php echo get_phrase('blog_category'); ?></a>
				</li>
			</ul>
		</li>
