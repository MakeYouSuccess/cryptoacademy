...
<form id="form_lesson" action="<?php echo site_url('admin/lessons/'.$param2.'/add'); ?>" method="post" enctype="multipart/form-data">
    ...
    <?php if ($param3 != 'editable' && $param3 != 'vimeo' && $param3 != 'youtube'): ?>
        <div class="form-group">
    ...
    <?php else:?>
        ...
        <?php if ($param3 == 'editable'): ?>
            <input type="hidden" name="lesson_type" value="editable-editable">
        <?php endif;?>
    <?php endif;?>

    <div class="text-center">
        <button class = "btn btn-success" type="submit" name="button" onclick="onSubmit(event)"><?php echo get_phrase('add_lesson'); ?></button>
    </div>
</form>
