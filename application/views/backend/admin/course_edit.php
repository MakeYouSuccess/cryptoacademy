                        ...
                        <form class="required-form" action="<?php echo site_url('admin/course_actions/edit/'.$course_id); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-pane" id="basic">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="for_whom"><?php echo get_phrase('who_is_it_for'); ?>?</label>
                                                    <div class="col-md-10">
                                                        <textarea name="for_whom" id = "for_whom" class="form-control"><?php echo $course_details['for_whom']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                            ...
                            <div class="tab-pane" id="media">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-xl-8">
                                        <div class="form-group row mb-3">
                                            <label class="col-md-2 col-form-label" for="course_temary_url"><?php echo get_phrase('course_temary_pdf'); ?></label>
                                            <div class="col-md-10" style="display:flex; align-items:center;">
                                                <a href="<?php echo base_url($course_details['temary_url']); ?>" target="_blank">
                                                    <?php echo $course_details['temary_url'] != "" ? base_url($course_details['temary_url']) : get_phrase('not_available_now'); ?>
                                                </a>
                                            </div>
                                            <div class="col-md-2"></div>
                                            <div class="col-md-10">
                                                <div>
                                                    <label for="temary_url" class="btn" style="border: 1px solid black; margin-bottom:0px;">
                                                        <i class="mdi mdi-upload"></i>
                                                        <?php echo $course_details['temary_url'] != "" ? get_phrase('update_temary') : get_phrase('upload_new'); ?>
                                                    </label>
                                                    <input id="temary_url" style="visibility:hidden;" type="file" class="image-upload" name="temary_url" accept=".pdf">
                                                    <!-- <input id="temary_url" style="visibility:hidden;" type="file" class="image-upload" name="temary_url" accept="image/*"> -->
                                                </div>
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
                                    ...
                                    <div class="col-xl-8">
                                        <div class="form-group row mb-3">
                                            <label class="col-md-2 col-form-label" for="course_temary_thumbnail"><?php echo get_phrase('course_temary_thumbnail'); ?></label>
                                            <div class="col-md-10">
                                                <div class="wrapper-image-preview" style="margin-left: -6px;">
                                                    <div class="box" style="width: 250px;">
                                                        <div class="js--image-preview" style="background-image: url(<?php echo base_url().$course_details['temary_thumbnail']; ?>); background-color: #F5F5F5;">
                                                        </div>
                                                        <div class="upload-options">
                                                            <label for="course_temary_thumbnail" class="btn"> <i class="mdi mdi-camera"></i> <?php echo get_phrase('course_temary_thumbnail'); ?> <br/> <small>(212 X 300)</small> </label>
                                                            <input id="course_temary_thumbnail" style="visibility:hidden;" type="file" class="image-upload" name="course_temary_thumbnail" accept="image/*">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
$('#temary_url').change(function() {
    var file = $('#temary_url')[0].files[0].name;
    $(this).prev('label').html('<i class="mdi mdi-upload"></i>' + file);
});
</script>
