<?php
$section_details = $this->crud_model->get_lessons('lesson', $param2)->row_array();
$lessons = $this->crud_model->get_lessons('section', $section_details['id'], 'les')->result_array();
?>
<div class="row">
    <div class="col-12">
        <div class="card">
                ...
                <div class="row" id = "parent-div" data-plugin="dragula" data-containers='["lesson-list"]'>
                    <div class="col-md-12">
                        <div class="bg-dragula p-2 p-lg-4">
                            <h5 class="mt-0"><?php echo get_phrase('sort_lessons_of').': '.$section_details['title']; ?>
