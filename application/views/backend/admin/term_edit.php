...
$term_details = $this->crud_model->get_lessons('lesson', $param2)->row_array();
?>
<!-- ACTUAL LESSON ADDING FORM -->
<form action="<?php echo site_url('admin/terms/'.$param3.'/edit'.'/'.$param2); ?>" method="post">

    <div class="form-group">
        <label><?php echo get_phrase('title'); ?></label>
        <input type="text" name = "title" class="form-control" required value="<?php echo $term_details['title']; ?>">
    </div>
