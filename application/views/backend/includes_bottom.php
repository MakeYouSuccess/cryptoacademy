...
<script src="<?php echo base_url('assets/backend/js/vendor/summernote-file.js'); ?>"></script>
<script src="<?php echo base_url('assets/backend/js/vendor/summernote-audio.js'); ?>"></script>
